...
var game = 
{
	...
	time: {total:20, current:59},      //TODO/*游戏时间*/
	score: 0,
	scoreNum: null
};
...
game.showMenu = function()
{
	...
	this.stage.addChild(this.begin);
}
...
game.gameOver = function()
{
   ...
   /* game.showEnd();*/
   /*===================================================sunjun=========================================================*/
    document.location='closegame?result=小朋友真棒，你接住了' + this.score + '个桃子！';
	this.stage.step();
...
game.showEnd = function(){
    ...
    end_num2.x = 25;
    end_num3.x = 50;
    container.addChild(end_num2, end_num3);
    ...
    this.stage.addChild(this.end, this.rePlayBtn, this.endNum);
