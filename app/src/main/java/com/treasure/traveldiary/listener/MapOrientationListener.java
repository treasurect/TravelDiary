package com.treasure.traveldiary.listener;
...
public class MapOrientationListener implements SensorEventListener {
    ...
    public MapOrientationListener(Context myContext) {//方向传感器的一个构造器
        super();
    ...
    public void setMapOrientationListener(onOrientationListener myOrientationListener) {
